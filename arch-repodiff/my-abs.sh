...
csup -L 1 -r 0 -g -b $ABSROOT/x86_64/current -P m -c .sup ./abs/supfile.arch-64

# extra
echo "${SEL}[extra/x86_64]${NORM}"
mkdir -p $ABSROOT/x86_64/extra
csup -L 1 -r 0 -g -b $ABSROOT/x86_64 -P m -c extra/.sup ./abs/supfile.extra-64

# community
echo "${SEL}[community/x86_64]${NORM}"
mkdir -p $ABSROOT/x86_64/community
csup -L 1 -r 0 -g -b $ABSROOT/x86_64 -P m -c community/.sup ./abs/supfile.community-64
...
csup -L 1 -r 0 -g -b $ABSROOT/i686/current -P m -c .sup ./abs/supfile.arch

# extra
echo "${SEL}[extra/i686]${NORM}"
mkdir -p $ABSROOT/i686/extra
csup -L 1 -r 0 -g -b $ABSROOT/i686 -P m -c extra/.sup ./abs/supfile.extra

# community
echo "${SEL}[community/i686]${NORM}"
mkdir -p $ABSROOT/i686/community
csup -L 1 -r 0 -g -b $ABSROOT/i686 -P m -c community/.sup ./abs/supfile.community
