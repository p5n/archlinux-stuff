 ...
 * streams
 */
class ipstream : virtual protected pstream
{
public:
    /**
     ...
     */
    _GLIBCXX_STD::streampos tellg();
    /**
     * This form moves the stream position to the absolute position given by
     * `pos'.
     */
    ipstream& seekg( _GLIBCXX_STD::streampos pos );
    /**
     ...
     * </pre>
     */
    ipstream& seekg( _GLIBCXX_STD::streamoff off, std::ios::seekdir dir );
    /**
 ...
 * streams
 */
class opstream : virtual protected pstream
{
public:
    /**
     ...
     * </pre>
     */
    opstream& seekp( _GLIBCXX_STD::streamoff off, std::ios::seekdir dir );
    /**
     * Flushes the stream.
     */
    opstream& flush();
 ...
 */
class fpbase : virtual protected pstream
{
public:
    /**
     ...
     * arguments.
     */
    fpbase( const char *name, int omode, int prot = std::ios_base::in );
    /**
     * Creates a buffered fpbase object. You can open a file and attach it to
     ...
     */
    void open( const char *name, int omode, int prot = std::ios_base::in );
    /**
...
public:
     ...
     * (protection) arguments.
     */
    fpstream( const char *name, int omode, int prot = std::ios_base::in );
    /**
     * Creates a buffered fpstream object. You can open a file and attach it
     * to the stream by specifying the file descriptor, `f'.
     */
